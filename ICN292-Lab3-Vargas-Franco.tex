...
\noindent Durante el desarrollo del laboratorio, se utilizó la URL de  prueba para verificar el funcionamiento de las reglas de negocio, analizar las solicitudes enviadas mediante el workflow EMISOR e identificar los errores producidos durante las pruebas adicionales.
\\\\
\noindent Esta configuración permitió observar directamente el recorrido de las solicitudes y comprobar los resultados obtenidos en cada ejecución.
